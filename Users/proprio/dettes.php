...
<html>
  ...
  <body id="page-top" >
     ...
     <a href="index.php"><img class="" src="" id="logo" title="logoGS"></a>
    <div class="container">
...
<div class="">
        ...
        <section id="section1" class="col-md-3">
            <div class="container">
                <div class="card border-success mb-3 text-uppercase" style="max-width: 18rem;">
                  <div class="card-header text-danger bg-success border-success text-center">dettes</div>
                    ...
                    <div class="card-body text-success">
                         <a class="nav-link active btn btn-warning" target="_self" href="dettes.php">Dettes</a>
                      </div>
                    <div class="card-body text-success">
    ...
    //section de code PHP pour affichage dans la colonne de droit
