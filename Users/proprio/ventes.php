        ...
        <section id="section1" class="col-md-3">
            <div class="container">
                <div class="card border-success mb-3 text-uppercase" style="max-width: 18rem;">
                  <div class="card-footer bg-dark text-success text-center border-success">ventes</div>
                     ...
                     <div class="card-body text-success">
                         <a class="nav-link active btn btn-secondary" target="_self" href="dispo_proprio.php">Produits</a>
