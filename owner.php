    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#services">Bilan</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#">Ventes</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#about">Commandes</a>
          </li>
          <!--<li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#team">équipe</a>
          </li>-->
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#">Inventaires</a>
          </li>
          <li class="nav-item">
