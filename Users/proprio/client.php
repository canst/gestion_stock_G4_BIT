...
<div class="container" id="allblock">
    <div class="row">
        <section id="section1" class="col-md-3">
            <div class="container">
                <div class="card border-success mb-3 text-uppercase" style="max-width: 18rem;">
                   <div class="card-header bg-success border-success text-center">client</div>
                    ...
                    <div class="card-body text-success">
                         <a class="nav-link active btn btn-success" target="_self" href="#clients">Clients</a>
                      </div>
                    <div class="card-body text-success">
        ...
        <section id="section2" class="col-md-8">
            ...
            <div class="container text-uppercase" id="creer">
                <form>
                      <a href="creerClient.php" class="btn btn-warning input-group" >Creer client</a>
                </form>
