...
<div class="">
    <div class="row">
        <section id="section1" class="col-md-3">
            <div class="container">
                <div class="card border-success mb-3 text-uppercase" style="max-width: 18rem;">
                  <div class="card-header text-danger bg-success border-success text-center">ventes</div>
                    ...
                    <div class="card-body text-success">
                         <a class="nav-link active btn btn-warning" target="_self" href="ventes.php">Ventes</a>
                      </div>
                    <div class="card-body text-success">
        ...
        <section id="section2" class="col-md-9 column">
            
                <div class="container" id="ventes">
                       <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Otto</td>
                          <td>soyotok@g.com</td>
                            <td><input type="submit" value="check" class="input-group btn btn-info"></td>
                        </tr>
