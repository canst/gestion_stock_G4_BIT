        ...
        <section id="section1" class="col-md-3">
            <div class="container">
                <div class="card border-success mb-3 text-uppercase" style="max-width: 18rem;">
                    <div class="card-header bg-light text-success border-success text-center">Livraison</div>
                     ...
                     <div class="card-body text-success">
                         <a class="nav-link active btn btn-light" target="_self" href="#livraisons">Livraisons</a>
                      </div>
                    <div class="card-body text-success">
                    ...
                    <div class="card-body text-success">
                         <a class="nav-link active btn btn-info" target="_self" href="#retraits">Retrait</a>
                      </div>
                   <div class="card-header bg-light text-success border-success text-center">Livraison</div>
                </div>
            </div>
